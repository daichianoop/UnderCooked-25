...
const Hero = () => {
    return (
        <section className="px-8 py-20 font-bold font-sans absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full overflow-scroll">
            <div className="container mx-auto flex flex-col items-center text-center max-w-3xl bg-black/60 px-10 py-20 rounded-b-full">
                {/* Heading */}
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight text-white">
                    Cattle Labs.
                    <span className="text-black px-4 rounded-full bg-white/90 mx-1">AI Based</span>Cattle Recognition Solution
                </h1>

                {/* Subtitle */}
                <p className="mt-6 mb-10 text-base sm:text-lg md:text-xl text-gray-300">
                    AI-powered cattle recognition for smarter livestock monitoring,<br/>
